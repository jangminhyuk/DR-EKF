...
def plot_trajectory_subplots(trajectory_data, filters_order, desired_traj, time, dist):
    ...
    # Create results directory - same as data directory
    results_dir = os.path.join("results", "EKF_comparison_with_FW")
    ...
    for filename in saved_files:
        print(f"- ./results/EKF_comparison_with_FW/{filename}")
...
def plot_subplots_all_filters(trajectory_data, filters_order, desired_traj, time, dist):
    ...
    print(f"EKF subplots trajectory figure saved to: ./results/EKF_comparison_with_FW/traj_2d_EKF_subplots_{dist}.pdf")
...
def plot_performance_vs_robustness(all_results, dist):
    ...
    print(f"Performance vs robustness plot saved to: ./results/EKF_comparison_with_FW/performance_vs_robustness_{dist}.pdf")
...
def create_individual_performance_plots(performance_data, filters_order, colors, filter_names, dist):
    ...
    print(f"Individual MSE plot saved to: ./results/EKF_comparison_with_FW/mse_vs_robustness_{dist}.pdf")
    print(f"Individual cost plot saved to: ./results/EKF_comparison_with_FW/cost_vs_robustness_{dist}.pdf")
...
def main():
    ...
    try:
        ...
        # Always create trajectory plots
