#!/usr/bin/env python3
"""
plot0_CT_joint.py: Trajectory visualization for EKF vs DR-EKF comparison results from main0_CT_joint.py
...
def plot_trajectory_subplots(trajectory_data, filters_order, desired_traj, time, dist):
    ...
    results_dir = os.path.join("results", "EKF_comparison_joint_CT")
    ...
    for filename in saved_files:
        print(f"- ./results/EKF_comparison_joint_CT/{filename}")
...
def plot_subplots_all_filters(trajectory_data, filters_order, desired_traj, time, dist):
    ...
    print(f"EKF subplots trajectory figure saved to: ./results/EKF_comparison_joint_CT/traj_2d_EKF_subplots_{dist}.pdf")
...
def main():
    parser = argparse.ArgumentParser(description='Create trajectory plots for EKF vs DR-EKF comparison from main0_CT_joint.py (CT model with joint DR-EKF)')
    ...
    try:
        ...
        results_path = "./results/EKF_comparison_joint_CT/"
